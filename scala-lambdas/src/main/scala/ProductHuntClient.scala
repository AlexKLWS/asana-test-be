...
object ProductHuntClient {
  ...
  object CollectionsOrder {
    ...
    case object NEWEST extends CollectionsOrder {
      val value: String = "NEWEST"
    }
  ...
  object CommentsOrder {
    case object NEWEST extends CommentsOrder {
      val value: String = "NEWEST"
    }
  ...
  object GoalsOrder {
    ...
    case object DUE_AT extends GoalsOrder {
      val value: String = "DUE_AT"
    }

    case object NEWEST extends GoalsOrder {
      val value: String = "NEWEST"
    }
  ...
  object MakerGroupsOrder {
    ...
    case object NEWEST extends MakerGroupsOrder {
      val value: String = "NEWEST"
    }
  ...
  object PostsOrder {
    ...
    case object NEWEST extends PostsOrder {
      val value: String = "NEWEST"
    }

    case object RANKING extends PostsOrder {
      val value: String = "RANKING"
    }

    case object VOTES extends PostsOrder {
      val value: String = "VOTES"
    }
  ...
  object TopicsOrder {
    ...
    case object NEWEST extends TopicsOrder {
      val value: String = "NEWEST"
    }
